    ...
    <form method="post" action="options.php">
        ...
        <div class="options_wrap_full">
            ...
            <div class="options_input options_text">      
                ...
                <?php $return_url = urlencode(admin_url('admin.php?page=add-instagram-feed-for-elementor')) . '&response_type=token&state='. admin_url('admin.php?add-instagram-feed-for-elementor'); ?>
